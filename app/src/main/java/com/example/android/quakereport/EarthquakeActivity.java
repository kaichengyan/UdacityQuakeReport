...
public class EarthquakeActivity extends AppCompatActivity
    ...
    private static final String USGS_QUERY_URL = "http://earthquake.usgs.gov/fdsnws/event/1/query";
    ...
    public Loader<List<Earthquake>> onCreateLoader(int id, Bundle args) {
        ...
        //?format=geojson&eventtype=earthquake&orderby=time&minmag=4&limit=10
        ...
        Uri base = Uri.parse(USGS_QUERY_URL);
